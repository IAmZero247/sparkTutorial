...
import static com.sparkTutorial.mylearning.performance.helper.SerializableComparator.serialize;
...
public class LogCountRDDVersion {
    public static void main(String[] args) {
        ...
        JavaRDD<String> input = sc.textFile("in/narrow_and_wide_transformation/biglog.txt");
